...
public final class ThinkEHRConfigurationParametersManager {

    private static final String JNDI_PREFIX = "java:comp/env/";

    private static final String CONFIGURATION_FILE = "ThinkEHR.properties";
	...
	try {
	    ...
	    Class<ThinkEHRConfigurationParametersManager> configurationParametersManagerClass = 
		    ThinkEHRConfigurationParametersManager.class;
		...
		Logger.getLogger(ThinkEHRConfigurationParametersManager.class).info("*** Using '"+CONFIGURATION_FOLDER+"' folder for '"+CONFIGURATION_FILE+"'");
	    }else{
		inputStream = classLoader.getResourceAsStream(CONFIGURATION_FILE);
		Logger.getLogger(ThinkEHRConfigurationParametersManager.class).info("*** Using resource for '"+CONFIGURATION_FILE+"'");
	    }
    ...
    private ThinkEHRConfigurationParametersManager() {}

    private static File getConfigFile(){
	try{
	    File jarFile = new File(ThinkEHRConfigurationParametersManager.class.getProtectionDomain().getCodeSource().getLocation().getPath());
	    //../conf
